...
import { FaCss3, FaCss3Alt, FaDatabase, FaFacebook, FaFire, FaGitSquare, FaGithub, FaHtml5, FaJava, FaJs, FaJsfiddle, FaLaravel, FaNodeJs, FaPhp, FaPython, FaReact, FaVuejs } from 'react-icons/fa'
